...
# @Last Modified by:   zhangyzihi
# @Last Modified time: 2023-01-04 16:52:46
...
class ImSpiRE_Parameters(object):
    ...
    def __init__(self):
        ...
        ## Feature extraction#
        self.FeatureParam_ProcessNumber=10
        ...
        self.CellProfilerParam_KernelNumber=10
        #OT Solver Params#
...
class ImSpiRE_HE_Image(object):
    ...
    def segment_spot_image(self,
        ...
        by setting the parameter CROP_SIZE. Default pixel size is 200*200.

        Parameters
        ----------
        pos_in_tissue_filter    -- Location matrices of filtered spots in tissue.
        output_path             -- Path to save spot subimages.
        crop_size               -- Pixel size of each spot subimage. Default is 200.
...
class ImSpiRE_Image_Feature(object):
    ...
    """
    def __init__(self, image_file_path, clip_limit = 0.01, n_processes = 10):
    ...
    def run_extract_features(self,
        ...
        crop_size       -- Pixel size of subimages. Default is 200.
